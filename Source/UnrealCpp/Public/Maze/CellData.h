...
UENUM(BlueprinType, meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = "true"))
...
public:
	...
	//언리얼이 만든것
	//TSharedPtr	: TObjectPtr과 비슷, 일반 C++ 포인터용. 가비지콜렉팅은 안됨, 레퍼런스 카운터 사용
	//TWeakPtr		: TWeakObjectPtr과 비슷, 일반 C++ 포인터용, 레퍼런스 카온터 증가하지 않음.
	//TUniquePtr;	: 주소가 한 변수에서만 유지됨, 복사불가능. 이동은 가능.
